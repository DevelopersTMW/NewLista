...
const ContactUs = () => {
  ...
  return (
    <>
      ...
      <section className=" relative flex justify-center px-20 gap-28 py-32 overflow-x-hidden ">
        {/* SHAPE  */}
        ...
        <div className="w-[58%] flex flex-col gap-8">
          ...
          <form className="flex flex-col gap-4">
            ...
            <div>
              ...
              <Textarea className={"bg-[#F3EEFF] border-[#F3EEFF] text-[#868686] font-[500] font-Urbanist text-[15px] w-[100%]  px-4 rounded-[6px] outline-none py-5"}  rows={6} name="description" placeholder="Please enter your message here..."></Textarea>
            </div>
