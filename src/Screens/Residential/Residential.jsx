        ...
        <form action="" className="flex flex-col gap-7">
          ...
          <div className="flex flex-col gap-4">
            ...
            <span className="flex gap-10">
              <Checkboxs labels={"Swimming Pools"}></Checkboxs>
              <Checkboxs labels={"Gyms"}></Checkboxs>
              <Checkboxs labels={"Theatres"}></Checkboxs>
            </span>
            <span className="flex gap-10">
              <Checkboxs labels={"Elevators"}></Checkboxs>
              <Checkboxs labels={"Convenience Store"}></Checkboxs>
              <Checkboxs labels={"Clubhouse"}></Checkboxs>
            </span>
            <span className="flex gap-10">
              <Checkboxs labels={"Jacuzzi"}></Checkboxs>
              <Checkboxs labels={"Security Features"}></Checkboxs>
              <Checkboxs labels={"Pet Parks"}></Checkboxs>
            </span>
          </div>
          <div>
