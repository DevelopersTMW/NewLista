        ...
        <div className='w-[95%] flex flex-col justify-between bg-white px-5 gap-5 py-7 sm:w-[30%] rounded-[14px]'>
          <div className='flex justify-between '>
            <span>
              ...
              <h1 className='font-Urbanist text-[#222222] text-[35px] font-[700]'>1,245</h1>
            </span>
            <span>
              <img src={DashboardIcon1_1} alt="" />
            </span>
          </div>
        ...
        <div className='w-[95%] flex flex-col justify-between bg-white px-5 gap-5 py-7 sm:w-[30%] rounded-[14px]'>
          <div className='flex justify-between'>
            <span>
              ...
              <h1 className='font-Urbanist text-[#222222] text-[35px] font-[700]'>1,103</h1>
            </span>
            <span>
        ...
        <div className='w-[95%] flex flex-col justify-between bg-white px-5 gap-5 py-7 sm:w-[30%] rounded-[14px]'>
          <div className='flex justify-between'>
            <span>
              ...
              <h1 className='font-Urbanist text-[#222222] text-[35px] font-[700]'>234</h1>
            </span>
            <span>
              <img src={DashboardIcon3_1} alt="" />
            </span>
          </div>
          <div className='flex items-center gap-2'>
            <span>
        ...
        <div className='w-[95%] flex flex-col justify-between bg-white px-5 gap-5 py-7 sm:w-[30%] rounded-[14px]'>
          <div className='flex justify-between'>
            <span>
              ...
              <h1 className='font-Urbanist text-[#222222] text-[35px] font-[700]'>12</h1>
            </span>
            <span>
