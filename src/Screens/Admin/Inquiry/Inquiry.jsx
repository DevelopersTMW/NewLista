...
import UnkownUser from "../../../../public/Images/UnknowUser.png"; // your unknown user image path
...
const Inquiry = () => {
  ...
  return (
    <div className="flex gap-8 h-[76vh] rounded-[10px] overflow-hidden my-5">
          ...
          <>
            ...
            <div className="p-6  flex flex-col gap-3 overflow-y-auto no-scrollbar relative overflow-hidden">
              {conversations[selectedChatIndex]?.messages?.map((msg) => (
                ...
                >
                  <div
                    className={`relative max-w-[80%] py-3 px-4 leading-1.5 ${
                      msg.type === "send"
      ...
      h-[48px] !max-h-[180px] leading-[20px] disabled:opacity-50"
              />
              <button
                type="submit"
