    ...
    <header className="bg-transparent relative z-10">
      ...
      >
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          ...
          {/* DROP DOWN MENU END */}
          <Link className="text-sm/6 font-[500] text-textColor font-Inter">About Us</Link>
          <Link className="text-sm/6 font-[500] text-textColor font-Inter">Pricing</Link>
          <Link className="text-sm/6 font-[500] text-textColor font-Inter">Contact</Link>
