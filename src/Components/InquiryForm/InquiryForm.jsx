  ...
  return (
    <div>
      <button
        ...
        className="bg-PurpleColor  flex justify-center items-center gap-2 text-white font-Urbanist px-3.5 py-2 text-[14px] rounded-[8px] cursor-pointer font-[600] hover-btn hover-btn-purple"
      >
