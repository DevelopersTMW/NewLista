    ...
    <form action="">
      <div className="flex flex-col gap-6">
        <div>
          ...
          <Inputs
            labels={`Name of ${propertyTypeName}`}
            type={"text"}
      ...
      <div className="border-t-[1px] border-solid border-[#999999] my-10">
        <div className="pt-8 flex flex-col gap-8">
          ...
          <div className="flex gap-8">
            <span className="w-[100%]">
              <Selection labels={"Space"} defaultOption={"Acres"}></Selection>
            </span>
            <span className="w-[100%]">
              <Inputs
                labels={"Space"}
          ...
          <div className="flex gap-8">
            <span className="w-[100%]">
              <Selection
                ...
                defaultOption={"Chose Your Property type"}
              ></Selection>
            </span>
            <span className="w-[100%]">
              <Selection
                labels={"Sub Property Type"}
                defaultOption={"Industrial "}
              ></Selection>
            </span>
            <span className="w-[100%]">
              <Selection labels={"Status"} defaultOption={"Active"}></Selection>
            </span>
          </div>
        </div>
      </div>
      <div className="border-t-[1px] border-solid border-[#999999] my-10">
        <div className="pt-8 flex gap-4 flex-col">
          ...
          <div className="flex gap-5">
            <Checkboxs labels={"Level"}></Checkboxs>
            <Checkboxs labels={"Rocky"}></Checkboxs>
            <Checkboxs labels={"Mountain"}></Checkboxs>
            <Checkboxs labels={"Hills"}></Checkboxs>
            <Checkboxs labels={"Desert"}></Checkboxs>
            <Checkboxs labels={"Lake"}></Checkboxs>
            <Checkboxs labels={"Canyon"}></Checkboxs>
            <Checkboxs labels={"Plateau"}></Checkboxs>
            <Checkboxs labels={"Valley"}></Checkboxs>
            <Checkboxs labels={"Beach"}></Checkboxs>
            <Checkboxs labels={"Other"}></Checkboxs>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-10">
        <div className="w-[40%]">
          <Selection labels={"Electricity"} defaultOption={"yes"}></Selection>
        </div>
        <div className="w-[60%] flex gap-4 flex-col pb-8">
          <span>
            <h1 className="font-Urbanist  block  font-[700] text-PurpleColor w-[100%] max-[1280px]:text-[14px] max-[1666px]:text-[15px] min-[1666px]:text-[16px]">
              Electricity Type
            </h1>
          </span>
          <div className="flex gap-2 flex-wrap">
            <Checkboxs labels={"City"}></Checkboxs>
            <Checkboxs labels={"County Municipal"}></Checkboxs>
            <Checkboxs labels={"Solar"}></Checkboxs>
            <Checkboxs labels={"Wind"}></Checkboxs>
            <Checkboxs labels={"Turbine"}></Checkboxs>
            <Checkboxs labels={"Other"}></Checkboxs>
          </div>
        </div>
      </div>
      ...
      <div className="flex gap-10">
        <div className="w-[40%]">
          <Selection labels={"Water"} defaultOption={"yes"}></Selection>
        </div>
        <div className="w-[60%] flex gap-4 flex-col pb-8">
          <span>
            <h1 className="font-Urbanist block  font-[700] text-PurpleColor w-[100%] max-[1280px]:text-[14px] max-[1666px]:text-[15px] min-[1666px]:text-[16px]">
          ...
          <div className="flex gap-2 flex-wrap">
            <Checkboxs labels={"City"}></Checkboxs>
            <Checkboxs labels={"County Municipal"}></Checkboxs>
            <Checkboxs labels={"Country Water Well"}></Checkboxs>
            <Checkboxs labels={"River"}></Checkboxs>
            <Checkboxs labels={"Creek"}></Checkboxs>
            <Checkboxs labels={"Other"}></Checkboxs>
          </div>
        </div>
      </div>
        ...
        <div className="w-[40%]">
          <Selection labels={"Sewer"} defaultOption={"yes"}></Selection>
        </div>
        <div className="w-[60%] flex gap-4 flex-col pb-8">
          <span>
            <h1 className="font-Urbanist  block  font-[700] text-PurpleColor w-[100%] max-[1280px]:text-[14px] max-[1666px]:text-[15px] min-[1666px]:text-[16px]">
          ...
          <div className="flex gap-4 flex-wrap">
            <Checkboxs labels={"City"}></Checkboxs>
            <Checkboxs labels={"County Municipal"}></Checkboxs>
            <Checkboxs labels={"Septic Tank "}></Checkboxs>
            <Checkboxs labels={" Private Septic Facility"}></Checkboxs>
            <Checkboxs labels={"Other"}></Checkboxs>
          </div>
        </div>
      </div>
