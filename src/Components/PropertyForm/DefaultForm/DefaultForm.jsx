      ...
      <div className="border-t-[1px] border-solid border-[#999999] my-10">
        <div className="pt-8 flex flex-col gap-8">
          ...
          <div className="flex gap-8">
            ...
            <span className="w-[100%]">
              <Selection labels={"Status"} defaultOption={"Acitve"}></Selection>
            </span>
          </div>
        </div>
      </div>
      <div className="border-t-[1px] border-solid border-[#999999] my-10">
        <div className="pt-8 flex gap-4 flex-col">
          ...
          <div className="flex gap-5">
            <span>
              <Checkboxs labels={"Indoor Cafe"}></Checkboxs>
              <Checkboxs labels={"Fitness Center"}></Checkboxs>
            </span>
            <span>
              <Checkboxs labels={"Conference Facility"}></Checkboxs>
              <Checkboxs labels={"Security Measures"}></Checkboxs>
            </span>
            <span>
              <Checkboxs labels={"WIFI"}></Checkboxs>
              <Checkboxs labels={"After Hour Operation"}></Checkboxs>
            </span>
            <span>
              <Checkboxs labels={"Executives Offcies"}></Checkboxs>
